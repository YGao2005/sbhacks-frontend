...
import { searchPapers } from './../collections/search-api';
...
export default function CollectionsPage() {
  ...
  const handleSaveToCollection = () => {
    // Only open modal if papers are selected
  ...
  // Get selected papers to pass to modal
  const selectedPapersList = searchResults.filter(paper => selectedPapers.has(paper.id));
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative mb-8">
          <div className="flex items-center bg-white rounded-full shadow-lg p-2">
            <div className="flex items-center px-3 text-gray-900">
            ...
            <Input
              ...
              className="flex-1 border-none focus:ring-0 text-base text-gray-900 placeholder:text-gray-400"
            />
            <Button 
